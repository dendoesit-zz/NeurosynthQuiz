...
(function() {
  ...
  window.Viewer = Viewer = (function() {
    ...
    function Viewer(layerListId, layerSettingClass, cache, options) {
      ...
      // ------------------------> important part 
       // console.log(options)
      xyz = 'xyz' in options ? options.xyz : [0,0,0];
    ...
    Viewer.prototype.getValue = function(layer, coords, space, all) {
      ...
      /* Get image value at a specific voxel. By default, returns the currently selected vowel for the currently active layer. Optionally, can pass a specific layer and/or coordinates (in viewer space) to use. If all is true,
